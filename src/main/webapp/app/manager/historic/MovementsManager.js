Ext.define('Dashboard.manager.historic.MovementsManager',{
    extend: 'Ext.app.Controller',
    alias: 'movementsManager',
    singleton: true,
    ...
    store: Ext.create('Dashboard.store.historic.Movements',{
        sorters: [{
        ...
        try{
            ...
            Dashboard.model.FeatureConfiguration.load(this.feature.data.name, {
                ...
                failure: function(record, operation) {
                    Dashboard.tool.Utilities.info('[MovementsManager.loadConfiguration] error: loading failure');
                    this.displayInMain();
                },
                success: function(record, operation) {
                     try {
                        ...
                        Dashboard.tool.Utilities.info('[MovementsManager.loadConfiguration] loading success. Feature: ' + model.data.featureName);

                        this.displayInMain();
                    } catch (ex) {
                        Dashboard.manager.FeaturesManager.deleteFeature(this.feature.data.name, 'MovementsManager'); // 6843
                    }
                }
            });
            
        }catch(err){
            Dashboard.tool.Utilities.error('[MovementsManager.loadConfiguration] error: ' + err);
        }
    ...
    displayInMain: function(){
        ...
        Dashboard.tool.Utilities.info('[MovementsManager.displayInMain] show movements Management feature');
        ...
        try{
            ...
            Dashboard.tool.Utilities.error('[MovementsManager.displayInMain] configuration error: ' + ex);
        }
        if(!configuration){
