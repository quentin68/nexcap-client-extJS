...
Ext.define('Dashboard.manager.alerts.CurItemsAlertsManager', {
    extend: 'Ext.app.Controller',
    alias: 'curItemsAlertsManager',
    singleton: true,
    
    requires: ['Dashboard.tool.Utilities'],
    
    store: Ext.create('Dashboard.store.alerts.Items', {
        autoLoad: false,
        ...
        try {
            ...
            Dashboard.model.FeatureConfiguration.load(feature.data.name, {
                ...
                failure: function (record, operation) {
                    Dashboard.tool.Utilities.info('[CurItemsAlertsManager.loadConfiguration] error: loading failure');
                ...
                success: function (record, operation) {
                    try {
                        ...
                        Dashboard.tool.Utilities.info('[CurItemsAlertsManager.loadConfiguration] loading success. Feature: ' + model.data.featureName);

                        this.loadUserConfiguration(feature);
                        
                    } catch (ex) {
                        Dashboard.manager.FeaturesManager.deleteFeature(feature.data.name, 'CurItemsAlertsManager'); // 6843
                    }
                }
            });

        } catch (err) {
            Dashboard.tool.Utilities.error('[CurItemsAlertsManager.loadConfiguration] error: ' + err);
        }
    ...
    loadUserConfiguration: function(feature){
        ...
        try {
            ...
            Dashboard.model.UserConfiguration.load(key, {
                scope: this,
                failure: function(record, operation) {
                    Dashboard.tool.Utilities.info('[CurItemsAlertsManager.loadUserConfiguration] error: loading failure');
                ...
                success: function(record, operation) {
                    try {
                        ...
                        Dashboard.tool.Utilities.info('[CurItemsAlertsManager.loadUserConfiguration] loading success. Feature: ' + configuration.data.featureName);
                                                                        
                    } catch (ex) {
                        Dashboard.tool.Utilities.error('[CurItemsAlertsManager.loadUserConfiguration] loading error: ' + ex);
                    }
    ...
    displayInMain: function (feature) {
        ...
        Dashboard.tool.Utilities.info('[CurItemsAlertsManager.displayInMain] show alerts Management feature');
        ...
        try {
            ...
            Dashboard.tool.Utilities.error('[CurItemsAlertsManager.displayInMain] configuration error: ' + ex);
        }
        if (!configuration) {
        ...
        mainController.displayInMain({
            ...
            tag: 'main',
            detailAlias: 'currentAlertItemDetail',
            manager: this
        });
    },
                ...
                columns: [
                    {
                        ...
                        width: 200,
                        sortable: true,
                        dataIndex: 'material.productReference.referenceCode',
                        cellWrap: false
                    }, {
                        ...
                        width: 200,
                        sortable: true,
                        dataIndex: 'material.productReference.designation',
                        cellWrap: false
                    },  {
                        ...
                        width: 200,
                        sortable: true,
                        dataIndex: 'material.productReference.productCategory.name',
                        cellWrap: false
                    }, {
                        text: getText('Alert manager'),
                        locked: false,
                        width: 200,
                        sortable: true,
    ...
    getProperties: function () {
        ...
        return [
            ...
            }, */
            {
                ...
                name: 'material.productReference.productCategory.name',
                type: 'STRING',
                control: Ext.encode({
                    field: {
            ...
            {
                name: 'material.productReference.referenceCode',
                label: getText('Ref. code'),
                type: 'STRING'
            }, {
                name: 'material.productReference.designation',
                label: getText('Ref. designation'),
                type: 'STRING'
            }, {
                name: 'material.location.address', 
                label: getText('Item address'),
                type: 'STRING',
                control: Ext.encode({
                    field: {
                        fieldType: 'address',
