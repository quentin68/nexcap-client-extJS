...
Ext.define('Dashboard.manager.alerts.DevicesAlertsManager', {
    extend: 'Ext.app.Controller',
    alias: 'devicesAlertsManager',
    singleton: true,
    
    requires: ['Dashboard.tool.Utilities'],
    
    store: Ext.create('Dashboard.store.alerts.Devices', {
        autoLoad: false,
    ...
    displayInMain: function (feature) {
        ...
        mainController.displayInMain({
            ...
            tag: 'main',
            detailAlias: 'currentAlertDeviceDetail'
        });
    },
                ...
                columns: [
                    {
                        ...
                        width: 200,
                        sortable: true,
                        dataIndex:'device.location.address'?'device.location.address':'device.position.address',
                        cellWrap: false
                    }, {
                        text: getText('Last connection date'),
                        locked: false,
                        width: 200,
                        sortable: true,
                        dataIndex:'device.lastConnectionDate',
                        cellWrap: false
                    }, {
                        text: getText('Software version'),
                        locked: false,
                        width: 200,
                        sortable: true,
                        dataIndex: 'device.softwareVersion',
                        cellWrap: false
                    }
                ]
            }
    ...
    getOne: function (id, controller, action) {
        ...
        try {
            Dashboard.model.alerts.DeviceAlert.load(id, {
                scope: this,
                failure: function (record, operation) {
        ...
        var properties = [
            {
                ...
                name: 'device.location.address'?'device.location.address':'device.position.address',
                ...
                name: 'device.lastConnectionDate',
