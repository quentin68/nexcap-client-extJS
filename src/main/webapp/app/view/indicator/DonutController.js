...
Ext.define('Dashboard.view.indicator.DonutController',{
    extend: 'Dashboard.view.indicator.IndicatorController',
    //extend: 'Ext.app.ViewController',
    alias: 'controller.donut',
    ...
    onEditWidget: function(sender){
        this.editWidget(sender.up('donut'));
    },
    ...
    updateValues: function(_statisticReferences){
        ...
        if(_statisticReferences === undefined){
            Dashboard.tool.Utilities.error('[DonutController.updateData] statisticReferences is undefined!');
            return;
        }
    ...
    statics: {
        ...
        buildIndicator: function(indicatorModel){
            ...
            if(!indicatorModel.data.id){
                throw new Error('[DonutController.buildWidget] indicatorModel.data.id is null!');
            }
...
//            });
            ...
            var indicator = Ext.create('Dashboard.view.indicator.Donut', data);
