...
Ext.define('Dashboard.view.indicator.StackedBarGraphController',{
    extend: 'Dashboard.view.indicator.IndicatorController',
    alias: 'controller.stackedBarGraph',
    ...
    onEditWidget: function(sender){
        this.editWidget(sender.up('stackedBarGraph'));
    },
    ...
    updateValues: function(statistics){
        ...
        Dashboard.tool.Utilities.debug('[StackedBarGraphController.updateValues] calculByType type :' + calculByType);
...
//            ];
        ...
        try{
            ...
            throw new Error('[StackedBarGraphController.updateData] set data store error! '+ ex);
        }
    },
    ...
    statics: {
        ...
        buildIndicator: function(indicatorModel){
            ...
            if(!indicatorModel.data.id){
                throw new Error('[StackedBarGraphController.buildWidget] indicatorModel.data.id is null!');
            }
            
            var dataBinding = indicatorModel.data.dataBinding;
            
            var indicator = Ext.create('Dashboard.view.indicator.StackedBarGraph',{
