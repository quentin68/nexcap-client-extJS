...
Ext.define('Dashboard.view.indicator.LineController',{
    ...
    onEditWidget: function(sender){
        this.editWidget(sender.up('line'));
    },
    ...
    editWidget: function(indicator){
        ...
        form.lookupReference('filled').setValue(indicator.record.data.dataBinding.filled);
    ...
    statics: {
        ...
        buildIndicator: function(indicatorModel){
            ...
            if(!indicatorModel.data.id){
                throw new Error('[LineController.buildWidget] indicatorModel.data.id is null!');
            }
            
            var dataBinding = indicatorModel.data.dataBinding;

            var indicator = Ext.create('Dashboard.view.indicator.Line',{
