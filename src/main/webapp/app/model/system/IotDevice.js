...
Ext.define('Dashboard.model.system.IotDevice', {
    ...
    proxy: Ext.create('Dashboard.model.Proxy', {
        api: {
            create: Dashboard.config.Config.SERVER_HOST_NAME + '/iotdevices',
            read: Dashboard.config.Config.SERVER_HOST_NAME + '/iotdevices',
            update: Dashboard.config.Config.SERVER_HOST_NAME + '/iotdevices',
            destroy: Dashboard.config.Config.SERVER_HOST_NAME + '/iotdevices'
        }
    })
});
