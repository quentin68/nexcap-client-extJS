Ext.define('Dashboard.view.consultation.maintenances.MainController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.consultationMaintenancesMain',
    
    require:[],
    
    className: 'MainController',
    feature: Ext.create('Dashboard.store.Features').findRecord('name', 'CUR_MAINTENANCE_INVENTORY', 0, false, true, true),  
    ...
    init: function() {
        ...
        this.className = Ext.getClass(this).getName();
         ...
         this.control({
            ...
            'consultationMaintenancesMain viewListGrid': {itemclick: this.onSelectItem}
        ...
        try{
            Dashboard.model.operation.Maintenance.load(id, {
                ...
                success: function(record, operation) {
                    ...
                    console.log('maintenances: ' + record.get('material.name'));
    ...
    displayDetail: function(record){
        //Ext.ComponentQuery.query('maintenancesDetail')[0].setData(record.data);
    ...
    exportToExel: function () {
        ...
        var link;
        if (contextSelected) {
            link= '/inventories/maintenances/export?context='+ encodeURIComponent(contextSelected);
        }
        else {
            link = '/inventories/maintenances/export';
        }
        //var link = '/inventories/maintenances/export';
        var data = Dashboard.engine.ExportToFile.getExportParams(main);
        Dashboard.engine.ExportToFile.doRequest(link, data, sort, filter);
    },

    getMain: function(){
        return  Ext.ComponentQuery.query('consultationMaintenancesMain')[0];
    }
});