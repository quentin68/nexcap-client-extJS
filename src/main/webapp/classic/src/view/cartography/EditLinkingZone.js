...
Ext.define('Dashboard.view.cartography.EditLinkingZone', {
    extend: 'Ext.window.Window',
    xtype: 'cartographyEditLinkingZone',
...
//                },
        ...
        this.buttons = [{
                ...
                listeners:{
                    scope: this,
                    click: function(me){
                        this.mainController.onEditMapLinkingZone(me);
                    }
                }
            }, {
                text: getText('Cancel'),
    ...
    getData: function(){
        ...
        this.record.data.map = {id: values.linkedMapId};
