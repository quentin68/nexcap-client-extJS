...
Ext.define('Dashboard.view.settings.specificCheckConfig.paragraph.Create', {
    extend: 'Ext.window.Window',
    xtype: 'paragraphCreate',
    requires: [
    ...
    initComponent: function() {
        ...
        this.title = getText('Create a  paragraph');
    ...
    getControl: function(){
        ...
        for(var i=0; i<list.length; i++){
            ...
            var options = list[i].query('field[name=options]')[0].value;
            var properties = list[i].query('field[name=properties]')[0].value;
            var comment = list[i].query('field[name=options]')[0].value;
            controlList.push({
