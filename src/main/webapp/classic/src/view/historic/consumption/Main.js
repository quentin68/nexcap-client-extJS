Ext.define('Dashboard.view.historic.consumption.Main', {
    ...
    requires: [
        ...
        'Dashboard.view.historic.consumption.Detail',
        'Dashboard.view.historic.consumption.ViewModel',
        'Dashboard.view.historic.consumption.MainController'
    ],
    
    controller: 'consumptionMain',
    store: null,
    configuration: null,
    feature: null,
    ...
    initComponent: function() {
        ...
        this.title = getText('Consumptions');
