...
Ext.define('Dashboard.view.administration.profile.Create', {
    ...
    initComponent: function() {
        ...
        this.title = getText('Create a profile');
            ...
            items: [
                {
                    ...
                    allowBlank: false,
                    emptyText: 'Name for the Profile...',
                    minLength: 4,
                    maxLength: 50,
                    listeners: {
                    ...
                    emptyText: 'Describe the profile...',
                    maxLength: 300
                } ,{
        ...
        var rightsFieldSet = Ext.create('Ext.panel.Panel',{
            ...
            items:[
                ...
                this.buildGroupCheckBoxField('CONSULTATION', 'CONSULTATION'), //Supervision
    ...
    */
    ...
    setRightsSelector: function (rightsList){
        ...
        var panelCartography = Ext.ComponentQuery.query('panel[name="CARTOGRAPHY"]')[0];
        ...
        for (var i = 0; i < rightsList.length; i++) {
            this.addProfile(i, rightsList[i]);
        }
    },
            
    addProfile: function(index, right){
