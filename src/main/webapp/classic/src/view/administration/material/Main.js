...
Ext.define('Dashboard.view.administration.material.Main', {
    ...
    requires: [
        ...
        'Dashboard.view.administration.material.MainController'
    ],
    ...
    initComponent: function() {
       ...
       this.title = Dashboard.manager.administration.MaterialManager.isAdmin ?  getText('Items administration') :  getText('Items inventory');
