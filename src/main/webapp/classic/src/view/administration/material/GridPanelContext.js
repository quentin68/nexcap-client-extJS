...
Ext.define('Dashboard.view.administration.material.GridPanelContext', {
        ...
        this.materialStore = Ext.create('Dashboard.store.Materials', {
            ...
            listeners: {
                ...
                beforeload: function (store, filters, eOpts){
                    store.getProxy().url = Dashboard.config.Config.SERVER_HOST_NAME + '/contexts/'  + contextId + '/materials';
                },
