...
Ext.define('Dashboard.view.administration.material.Selector', {
    extend: 'Ext.window.Window',
    xtype: 'materialSelector',

    requires: [
        'Dashboard.tool.Utilities',
        'Dashboard.view.administration.material.GridPanel'
    ],
    ...
    initComponent: function () {
        ...
        this.title = getText('Select an item to add');
        ...
        var gridPanel = Ext.create('Dashboard.view.administration.material.GridPanel');
        ...
        this.buttons = [
            {
                ...
                listeners: {
                    ...
                    click: function (me, e, eOpts) {
                        this.parentController.onSelectMaterial(me);
                    }
                }
            }, {
                text: getText('Cancel'),
