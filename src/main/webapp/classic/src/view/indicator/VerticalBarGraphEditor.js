...
Ext.define('Dashboard.view.indicator.VerticalBarGraphEditor', {
    extend: 'Ext.window.Window',
    xtype: 'verticalBarGraphEditor', //Bad name : Horizontal multicolored !!
    ...
    controller:'verticalBarGraphEditor',
    ...
    initComponent: function() {
        ...
        this.title = getText('Horizontal bar graph editor');
...
//        };
        ...
        var chartFieldSet = {
            ...
            items:[
                
                {
                    ...
                    fieldLabel: getText('Multicolored'),
    ...
    */
    ...
    buildFilters: function(){
        ...
        Dashboard.tool.Utilities.info('[VerticalBarGraphEditor.buildFilters] filters: '+ Ext.encode(filtersNamesList));
...
//        data.dataBinding.yTitle = values.yTitle;
        ...
        if(values.multicolored){
            data.dataBinding.multicolored = true;
        }
...
//        var address = this.down('autocompleteComboBox[reference=address]');
        
//        if(address.getValue() && address.getSelection() === null){
//            
//            var filters = this.record.data.dataBinding.filters;
//            var index = Dashboard.tool.Utilities.findIndex(filters, 'filter', 'LOCATION_ID');
//            
//            if(index && index !== -1){
//                var value = filters[index].value;
