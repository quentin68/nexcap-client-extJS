Ext.define('Dashboard.view.shared.viewList.AlbumConfiguration',{
    extend: 'Ext.window.Window',
    xtype: 'viewListAlbumConfiguration',
    ...
    controller: 'viewListAlbumConfiguration',
    modelProperties: null,
    mainView: null,    
    
    initComponent: function() {
        
        this.title = getText('Album configuration');
...
//                },
    ...
    getData: function(){
        ...
        var caption = this.mainView.configuration.album.caption;
