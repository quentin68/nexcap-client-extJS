Ext.define('Dashboard.view.system.device.Selector', {
    extend: 'Ext.window.Window',
    xtype: 'deviceSelector',
    ...
    initComponent: function () {
        ...
        this.title = getText('Select devices to Add');
        ...
        var deviceGridPanel = Ext.create('Dashboard.view.system.device.GridPanel',{
            region: 'center',
            margin : '16 0 0 0',
        ...
        this.buttons = [
            {
                ...
                listeners: {
                    ...
                    click: function (me, e, eOpts) {
                        this.parentController.onSelectDevices(me);
                    }
                }
