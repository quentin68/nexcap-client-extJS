...
Ext.define('Dashboard.view.system.dynamicProperties.TelemetryCreateController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.dynamicPropertiesTelemetryCreate',

    require: ['Dashboard.model.Property'],

    view: 'dynamicPropertiesTelemetryCreate',
