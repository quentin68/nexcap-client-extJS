...
To run the Karma tests follow these steps: 

* Install latest stable version of [NodeJS](https://nodejs.org/) .

* Open a terminal/console in the `webapps` directory.

* Type this command to install the required dependencies: `npm install --only=dev`

* Start the tests using this command : `npm test`


### Browsers

If you use diffrent browsers than the ones specified in `karma.conf.js:83`, 
head to [this link](https://www.npmjs.com/browse/keyword/karma-launcher) and 
install the launcher you need, then add it to the `karma.conf.js:83` list.
