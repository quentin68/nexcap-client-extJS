...
Ext.define('Dashboard.view.administration.user.SelectorToDelete', {
    extend: 'Ext.window.Window',
    xtype: 'userSelectorToDelete',

    requires: [
        'Dashboard.tool.Utilities',
        'Dashboard.view.administration.user.GridPanelContext'
    ],
    ...
    initComponent: function() {
        ...
        this.title = getText('Select users to delete');
        ...
        var gridPanel = Ext.create('Dashboard.view.administration.user.GridPanelContext',{
            region: 'center',
            margin : '16 0 0 0',
            conID: this.conID
        });
        ...
        this.buttons = [
            {
                text: getText('Select'),
                action: 'selectUserDelete',
                listeners:{
                    scope: this,
                    click: function( me , e , eOpts ){
                        // console.log('me',me);
                        this.parentController.onSelectUsersToDelete(me);
                    }
                }
