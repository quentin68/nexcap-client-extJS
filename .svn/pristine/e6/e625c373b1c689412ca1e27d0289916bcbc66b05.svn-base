...
Ext.define('Dashboard.view.shared.viewList.CreateExtendedRow', {
    extend: 'Ext.window.Window',
    xtype: 'viewListCreateExtendedRow',
    requires: [
    ...
    controller: 'viewListCreateExtendedRow',
    mainController: null,
