...
Ext.define('Dashboard.view.shared.property.Selector', {
    ...
    initComponent: function () {
        ...
        if (this.typeOfValidation === 'PRODUCTREFERENCE') {
            this.subtitle = getText('Select a reference property to add');
            this.type = 'PRODUCTREFERENCE';
            
        } else if (this.typeOfValidation === 'MATERIAL') {
            this.subtitle = getText('Select an item property to add');
            this.type = 'MATERIAL';
            
        } else {
            this.subtitle = getText('Select a property to add');
            this.type = null;
        }
        ...
        var propertyGridPanel = Ext.create('Dashboard.view.shared.property.GridPanel',{
            region: 'center',
            margin : '16 0 0 0',
            type: type
        });
        ...
        this.buttons = [
            {
                ...
                listeners: {
                    ...
                    click: function (me, e, eOpts) {
                        this.parentController.onSelectProperties(me);
                    }
                }
            }, {
                text: getText('Cancel'),
