...
Ext.define('Ext.form.action.Action', {
    ...
    statics: {
        ...
        /**
         * @property
         * Failure type returned when the response's `success` property is set to false, and error has name
         * test this
         * @static
         */
        INVENTORY_REPORT_UNKNOWN: 'inventory',
         ...
         * @static
         */
        PACKAGE_NAME_ALREADY_EXIST: 'package'
