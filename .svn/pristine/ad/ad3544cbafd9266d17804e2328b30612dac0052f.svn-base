Ext.define('Dashboard.view.shared.filtering.MaterialCurState',{
    extend: 'Dashboard.view.shared.component.AutocompleteComboBox',
    xtype : 'filter.materialCurStateFilter',
    type: 'filter',
    ...
    border: false,
    name: null,
    fieldLabel: getText('Current state'),
    displayField: 'name',
    valueField: 'name',
    requires : ['Dashboard.store.properties.CurStates'],
    store: Ext.create('Dashboard.store.properties.CurStates', {
        autoLoad: false
    }),
