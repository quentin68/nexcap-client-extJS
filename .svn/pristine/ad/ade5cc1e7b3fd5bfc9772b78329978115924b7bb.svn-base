Ext.define('Dashboard.view.system.device.GridPanel', {
    ...
    initComponent: function () {
        ...
        var me = this;
        var rootPosition = this.rootPosition;
        this.deviceStore = Ext.create('Dashboard.store.system.Devices', {
            autoLoad: true,
            listeners: {
                scope: this,
                beforeload: function (store, operation, eOpts) {
                    store.getProxy().url = Dashboard.config.Config.SERVER_HOST_NAME + '/devices/search/' + rootPosition;
                },
