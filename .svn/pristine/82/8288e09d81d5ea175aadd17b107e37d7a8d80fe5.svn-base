...
Ext.define('Dashboard.view.indicator.BarGraphEditor', {
    extend: 'Ext.window.Window',
    xtype: 'barGraphEditor',
    ...
    initComponent: function() {
        ...
        this.title = getText('Bar graph editor');
...
//        };
    ...
    */
    ...
    addPropertySelector: function(color, label, name, correlationId){
        
        var selector = this.getPropertySelector(color, label, name, correlationId); 
        this.down('form').down('panel[reference=propertiesSelectors]').add(selector);
    ...
    buildFilters: function(){
        ...
        Dashboard.tool.Utilities.info('[BarGraphEditor.buildFilters] filters: '+ Ext.encode(filtersNamesList));
