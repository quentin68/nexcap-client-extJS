...
Ext.define('Dashboard.view.indicator.VerticalBarGraphController',{
    extend: 'Dashboard.view.indicator.IndicatorController',
    alias: 'controller.verticalBarGraph',
    ...
    onEditWidget: function(sender){
        this.editWidget(sender.up('verticalBarGraph'));
    },
...
//        form.lookupReference('yTitle').setValue(indicator.record.data.dataBinding.yTitle);
        form.lookupReference('multicolored').setValue(indicator.record.data.dataBinding.multicolored);
    ...
    statics: {
        ...
        buildIndicator: function(indicatorModel){
            ...
            if(!indicatorModel.data.id){
                throw new Error('[VerticalBarGraphController.buildWidget] indicatorModel.data.id is null!');
            }
            
            var dataBinding = indicatorModel.data.dataBinding;
            
            var indicator = Ext.create('Dashboard.view.indicator.VerticalBarGraph',{
