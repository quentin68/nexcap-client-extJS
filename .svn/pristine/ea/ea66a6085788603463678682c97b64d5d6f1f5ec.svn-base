...
Ext.define('Dashboard.view.system.alertsConfiguration.CreateAlert', {
    ...
    initComponent: function() {
        ...
        var calculationRulesStore = Ext.create('Dashboard.store.settings.AlertsConfiguration', {
            autoDestroy: true
        });
        ...
        var comboAlertModelTypes = {
            ...
            listeners: {
                ...
                change: function(f) {
                    ...
                    calculationRulesStore.proxy.url = Dashboard.config.Config.SERVER_HOST_NAME + '/alertconfigurationbean/listwithtrigger/'  + comboVal ;
                    calculationRulesStore.load();
    ...
    displayTriggers: function(obj){
        var operations = obj.data.compatibleTriggers;
    ...
    getData: function(){
        ...
        values.alertConfigurationBean = {'id' : values.beanid};
          ...
          Ext.Array.each(triggersRecords, function (rec){
            if (rec.inputValue) {
                ...
                if (triggerEnum === "NEW_HOUR") {
                    parameters =  '0:' + values.minutes_NEW_HOUR;
                }
